...
<body>
    ...
    <img src="images/task7.png" width="430px" style="z-index: 1;">
    </div>
      ...
      <div id="contact" style="z-index: 1; position: absolute; margin-left:2%; margin-top: 30vh;">
            <div class="form-row">
             <div class="form-group" style="margin-left:270px; margin-top: 200px;"> 
                <h1>Contact Us</h1>
                <p class="lead">&nbsp;<i class="fas fa-mobile"></i>&nbsp; (+91) 9876543210</p>
                <p class="lead">&nbsp;<i class="fas fa-at"></i>&nbsp; admin1@gmail.com</p>
              </div>
              <div class="form-group" >
              <img src="images/contact.png" alt="..." style="width: 600px; margin-left: 30%; margin-top: -25%;">
              </div>
            </div>
    </div>
